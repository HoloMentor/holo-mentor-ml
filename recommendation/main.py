...
async def generate_quiz(class_id: int , student_id: int ):
    try:
        ...
        if check_already_quiz_generated:
            raise HTTPException(status_code=600, detail="Custom quiz already generated for this student this week.")
            ...
            if res:
                return HTTPException(status_code=600, detail="Custom quiz generated successfully.")
            else:
